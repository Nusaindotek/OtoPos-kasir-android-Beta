...
let editId = null; // untuk edit part/mekanik
...
function bukaModal(id){
    ...
    if(id === 'modal-setting') loadRiwayat();
}
...
function hapusMekanik(id){
    ...
    localStorage.setItem('mekanik', JSON.stringify(mekanik));
    loadMekanik(); loadMekanikToSelect();
}
